const app = getApp(),
    qqmapsdk = require("../../../utils/map"),
    config = require("../../../utils/config"),
    Amap = require('../../../utils/azm/amap'),
    util = require("../../../utils/azm/util"),
    coordtransform = require("../../../utils/azm/coordtransform"),
...
Component({
    ...
    methods: {
        ...
        onTap(e){
            ...
            if (this.data.address === '加载中...') {
                ...
                let page = app.util.getCurrentPage(),
                    url = '/pages/loc/index',
                    data = {};
                if (page.route === 'pages/index/near') {
                    data = {
                        is: 1
                    }
                }
        ...
        setCallback(address, myEventDetail, myEventOption){
            let that = this;
            console.log(that.triggerEvent('callback', myEventDetail, myEventOption), 'ddd');
